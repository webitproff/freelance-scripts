...
<div class="uk-margin uk-margin-top uk-alert uk-bg-warnlight shadow-warnlight uk-padding-small uk-panel uk-border-rounded" uk-alert>
  <a class="uk-alert-close" uk-close></a>
  <p class="uk-h4 uk-text-middle">
    <span class="uk-margin-small-right uk-txt-warnlight"><i class="fa-solid fa-triangle-exclamation fa-2xl"></i></span> <span class="uk-margin-small-right uk-text-bold uk-txt-warnlight">{PHP.L.Warning} !!!</span>
  </p>
    <p class="uk-text-bold uk-text-danger uk-margin-remove uk-padding-remove">{PHP.L.Ctrl_Install_Ext_backup_DB}</p>
    <p class="uk-text-bold uk-text-primary uk-margin-remove uk-padding-remove">{PHP.L.Ctrl_Install_Ext_backup_DB_desc}</p>
</div>
...
<!--ENDIF -->">{ADMIN_EXTENSIONS_DEPENDENCIES_ROW_NAME} </span>
    ...
    <div class="uk-width-1-3@l">
      <ul class="uk-nav uk-nav-divider">
        ...
        <!-- ENDIF -->
		<li>
		<a uk-tooltip="{PHP.L.Rights}" class="uk-link-text" href="{ADMIN_EXTENSIONS_RIGHTS}">
			<span class="uk-text-middle">
				<i class="ti ti-scale uk-h2 uk-text-warning"></i>
			</span>
		  <span class="uk-text-middle uk-text-medium uk-margin-small-left">{PHP.L.Rights}</span>
		</a>
        </li>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a uk-tooltip="{PHP.L.adm_opt_pause}" class="uk-icon-button uk-button-warning" href="{ADMIN_EXTENSIONS_DETAILS_ROW_PAUSEPART_URL}" title="{PHP.L.adm_opt_pause}">
