...
<h1 class="m-y-2">{PHP.L.market_edit_product_title}</h1>
<div class="card">
	<div class="card-block">
		...
		<form action="{PRDEDIT_FORM_SEND}" method="post" name="edit" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="form-group row">
				<label class="col-md-3 form-control-label">{PHP.L.market_location}:</label>
			...
			<!-- END: TAGS -->
			<div class="form-group row">
				<label class="col-md-3 form-control-label">{PHP.L.market_price}:</label>
				<div class="col-md-9">
