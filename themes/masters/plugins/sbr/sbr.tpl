...
<div class="pull-xs-right"><span class="label label-{SBR_LABELSTATUS}">{SBR_LOCALSTATUS}</span></div>
<h1>{SBR_SHORTTITLE}</h1>

<ul class="nav nav-tabs">
	<li class="nav-item"><a class="nav-link<!-- IF !{PHP.num} --> active<!-- ENDIF -->" href="{SBR_URL}">{PHP.L.sbr_nav_info}</a></li>
	<!-- BEGIN: STAGENAV_ROW -->
	<li class="nav-item">
		<a class="nav-link<!-- IF {PHP.num} == {STAGENAV_ROW_NUM} --> active<!-- ENDIF -->" href="{STAGENAV_ROW_URL}">
