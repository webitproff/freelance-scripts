...
<a class="btn btn-success pull-xs-right" href="{PHP|cot_url('support', 'm=newticket')}">{PHP.L.support_tickets_add_button}</a>
<!-- ENDIF -->
<ul class="nav nav-tabs">
	<li class="nav-item"><a class="nav-link<!-- IF {PHP.status} == 'open' --> active<!-- ENDIF -->" href="{PHP|cot_url('support','status=open')}">{PHP.L.support_tickets_open}</a></li>
	<li class="nav-item"><a class="nav-link<!-- IF {PHP.status} == 'closed' --> active<!-- ENDIF -->" href="{PHP|cot_url('support','status=closed')}">{PHP.L.support_tickets_closed}</a></li>	
	<li class="nav-item"><a class="nav-link<!-- IF {PHP.status} == 'all' --> active<!-- ENDIF -->" href="{PHP|cot_url('support', 'status=all')}">{PHP.L.All}</a></li>
</ul>
