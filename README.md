...
# После успешной установки и авторизации в админке снова пройдите по адресу http://tvoy-domen.com/install.php для Обновление Cotonti с 0.9.19 до 0.9.20, - будет установлен patch_0.9.20.sql #
Версия сборки: 2.7.1
