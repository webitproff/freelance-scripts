...
{	
	...
	switch ($for) {
		...
		case 'market':
			...
			break;
		case 'services':
			$queryToDB = "SELECT item_title, item_id FROM $db_services WHERE item_alias = ''";
			break;
		case 'folio':
...
$t->assign(array(
	...
	'AUTOALIAS_SERVICES_CREATE' => cot_url('admin', 'm=other&p=autoalias2lance&a=create&aliasfor=services'),
