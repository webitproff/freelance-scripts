...
$maxrowsperpage = $cfg['plugin']['prdmap']['indexlimit'];
...
$t = new XTemplate(cot_tplfile(array('prdmap', 'page'), 'plug'));
...
$catpatharray[] = array(cot_url('plug', 'e=prdmao'), $L['market']);
...
$t->assign(array(
	"SEARCH_ACTION_URL" => cot_url('plug', 'e=prdmap', '', true),
