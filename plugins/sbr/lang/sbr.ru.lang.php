...
$L['sbr'] = 'Защищенные Сделки';
$L['sbr_mydeals'] = 'Мои Защищенные Сделки';
...
$L['sbr_nav_info1'] = 'Информация о сделке';
$L['sbr_nav_info2'] = 'Бюджет и сроки';
...
$L['sbr_stagetitle'] = 'Название, Заголовок этапа сделки';
$L['sbr_stagetext'] = 'Техническое задание на данном этапе';
...
$L['sbr_maxcost'] = 'Предельно допустимый бюджет';
...
$L['sbr_posts_add'] = 'Добавить сообщение';
$L['sbr_posts_to'] = 'Кому';
